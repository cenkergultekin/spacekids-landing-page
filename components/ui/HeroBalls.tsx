...
const XConfig = {
  count: 150,
  // Colors: Purple, Navy Blue, Yellow
  colors: [0x7e22ce, 0x1e3a8a, 0xfacc15],
...
class Z extends InstancedMesh {
  ...
  setColors(colors: number[]) {
    ...
    // Assign colors evenly across instances using round-robin for near-equal distribution
    for (let idx = 0; idx < this.count; idx++) {
      const color = new Color(colors[idx % colors.length]);
